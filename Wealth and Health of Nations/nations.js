...
// Updated scale funtions to match D3 v4 environment changes
...
d3.json("nations.json", function(nations) {
  ...
  function position(dot) {
    dot .attr("cx", function(d) { return xScale(x(d)); })
        ...
        .attr("r", function(d) { return radiusScale(radius(d)*4.25); });
  }
  ...
  // Updated linear scale funtion to match D3 v4 environment changes
